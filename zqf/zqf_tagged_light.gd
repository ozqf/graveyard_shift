...
static func broadcast_change(tree:SceneTree, subGroup:String, queryTag:String, on:bool) -> void:
	tree.call_group(GROUP_NAME, FN_TAGGED_LIGHTS_CHANGE, subGroup, queryTag, on)
